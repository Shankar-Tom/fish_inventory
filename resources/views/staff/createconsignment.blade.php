       ...
       <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <form class="forms-sample" method="post" action="{{route('staff.storeconsigment')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <h4 class="card-title">Your Purchases</h4>
                    @php($uncongsineds=\App\Models\Purchase::where('staff_id',Auth('staff')->id())->doesnthave('Consigned')->get())
