       ...
       <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <form class="forms-sample" method="post" action="{{route('staff.storesale',[$id->id])}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <div class="form-group col-md-3">
                  ...
                  <div class="form-group col-3">
                    <label for="exampleInputCity1">Payment Mode</label>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            @forelse  ($PurchasesUnSold as $product)
                                  <tr>
                                    <td> <input type="checkbox" name="selected[{{$i}}]" id=""  value="{{$product->id}}"></td>
                                      <td>{{$product->product}}</td>
                                      <td>{{$product->Port->port_name}}</td>
